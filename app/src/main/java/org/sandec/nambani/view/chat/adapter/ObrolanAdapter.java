...
public class ObrolanAdapter extends RecyclerView.Adapter<ObrolanAdapter.ObrolanViewHolder> {
    ...
    public ObrolanViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(org.sandec.nambani.R.layout.item_obrolan,parent,false);
    ...
    public class ObrolanViewHolder extends RecyclerView.ViewHolder {
        ...
        public ObrolanViewHolder(View itemView) {
            super(itemView);
            ll = (ChatMessageView)itemView.findViewById(org.sandec.nambani.R.id.messaage_chat);
            ll2 = (ChatMessageView)itemView.findViewById(org.sandec.nambani.R.id.messaage_chat2);
            tvObrolan = (TextView)itemView.findViewById(org.sandec.nambani.R.id.tv_text_obrolan);
            tvObrolan2 = (TextView)itemView.findViewById(org.sandec.nambani.R.id.tv_text_obrolan2);
        }
    }
