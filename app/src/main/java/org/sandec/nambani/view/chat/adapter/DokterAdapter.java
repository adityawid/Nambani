package org.sandec.nambani.view.chat.adapter;
...
import org.sandec.nambani.view.chat.ObrolanKlinikita;
...
public class DokterAdapter extends RecyclerView.Adapter<DokterAdapter.DokterViewHolder> {
    ...
    public DokterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(org.sandec.nambani.R.layout.item_dokter_klinikita,parent,false);
    ...
    public class DokterViewHolder extends RecyclerView.ViewHolder {
        ...
        public DokterViewHolder(View itemView) {
            super(itemView);
            imageDokter = (ImageView)itemView.findViewById(org.sandec.nambani.R.id.iv_dokter);
            nameDokter = (TextView)itemView.findViewById(org.sandec.nambani.R.id.tv_namaDokter);
            bidang =(TextView)itemView.findViewById(org.sandec.nambani.R.id.tv_bidang_dokter);
            harga = (TextView)itemView.findViewById(org.sandec.nambani.R.id.tv_status_dokter);
            llMore = (LinearLayout)itemView.findViewById(org.sandec.nambani.R.id.ll_more);
            tvseeMore = (TextView) itemView.findViewById(org.sandec.nambani.R.id.tv_see_more);
            tvlessMore = (TextView) itemView.findViewById(org.sandec.nambani.R.id.tv_less_more);
            btn_chat = (TextView)itemView.findViewById(org.sandec.nambani.R.id.button_chat);
