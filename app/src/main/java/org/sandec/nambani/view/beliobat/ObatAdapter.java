...
public class ObatAdapter extends  RecyclerView.Adapter<ObatAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(org.sandec.nambani.R.layout.activity_obat_item_list, parent, false);
...
//        });
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            ivGambarWisata = (ImageView) itemView.findViewById(org.sandec.nambani.R.id.iv_item_gambar);
            tvAlamatWisata = (TextView) itemView.findViewById(org.sandec.nambani.R.id.tv_item_alamat);
            tvNamaWisata = (TextView) itemView.findViewById(org.sandec.nambani.R.id.tv_item_nama);
        }
    }
}
