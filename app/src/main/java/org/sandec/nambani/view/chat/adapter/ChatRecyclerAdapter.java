...
public class ChatRecyclerAdapter extends RecyclerView.Adapter<ChatRecyclerAdapter.ChatViewHolder> {
    ...
    public ChatViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(org.sandec.nambani.R.layout.item_chat, parent, false);
    ...
    public class ChatViewHolder extends RecyclerView.ViewHolder {
        ...
        public ChatViewHolder(View itemView) {
            super(itemView);
            chatImage = (ImageView) itemView.findViewById(org.sandec.nambani.R.id.iv_klinikk);
            username = (TextView) itemView.findViewById(org.sandec.nambani.R.id.tv_username);
            history = (TextView) itemView.findViewById(org.sandec.nambani.R.id.tv_history);
            jam = (TextView) itemView.findViewById(org.sandec.nambani.R.id.tv_jam);
            lingkaran = (TextView) itemView.findViewById(org.sandec.nambani.R.id.tv_lingkaran);
