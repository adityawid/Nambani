package org.sandec.nambani.view.more.adapter;
...
import org.sandec.nambani.view.dompetkita.DompetKitaActivity;
...
public class MoreRecyclerAdapter extends RecyclerView.Adapter<MoreRecyclerAdapter.MoreViewHolder> {
    ...
    public MoreViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(org.sandec.nambani.R.layout.item_more, parent, false);
    ...
    public static class MoreViewHolder extends RecyclerView.ViewHolder {
        ...
        public MoreViewHolder(View itemView) {
            super(itemView);
            moreImage = (ImageView) itemView.findViewById(org.sandec.nambani.R.id.iv_klinik);
            moreText = (TextView) itemView.findViewById(org.sandec.nambani.R.id.tv_klinik);
            moreLL = (LinearLayout) itemView.findViewById(org.sandec.nambani.R.id.ll_mater_more);
        }
