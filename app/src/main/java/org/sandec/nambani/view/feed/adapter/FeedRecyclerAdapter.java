package org.sandec.nambani.view.feed.adapter;
...
public class FeedRecyclerAdapter extends RecyclerView.Adapter<FeedRecyclerAdapter.FeedViewHolder>{
    ...
    public FeedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(org.sandec.nambani.R.layout.item_feed,parent,false);
    ...
    public static class FeedViewHolder extends RecyclerView.ViewHolder {
        ...
        public FeedViewHolder(View itemView) {
            super(itemView);
            feedImage = (ImageView)itemView.findViewById(org.sandec.nambani.R.id.iv_feed);
            feedText = (TextView)itemView.findViewById(org.sandec.nambani.R.id.tv_username);
        }
    }
}
